        ...
        >
          ...
          <div className="md:flex md:items-center">
            <div className="md:w-1/3">
              <button
                type="submit"
                className="shadow bg-teal-500 hover:bg-teal-600 dark:bg-teal-700 dark:hover:bg-teal-800 transition focus:shadow-outline text-white dark:text-teal-50 font-semibold py-2 px-4 uppercase italic rounded"
              >
                Send
              </button>
            </div>
