...
blurb:  I recently migrated my personal website infrastructure from a VPS to AWS S3 + CloudFront, with infrastructure managed by Terraform.
...
<figure className="image">
  <img src="/img/waterfall-vps.png" alt="Waterfall VPS" />
  <figcaption>Waterfall when serving over VPS</figcaption>
</figure>

<figure className="image">
  <img src="/img/waterfall-cdn.png" alt="Waterfall CDN" />
